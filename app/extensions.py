...
class NCLAgent:
    def __init__(self, data_path: Path | str):
        self.qdrant_client = QdrantClient(url=Config.QDRANT_CLUSTER, api_key=Config.QDRANT_API_KEY)
        ...
        self.data = {
            class_item["class_id"]: class_item
    ...
    def search_per_collection(self, query_vector: list[float], collection: str, limit_candidate: int = 2):
    ...
    def infer(self, description: str, limit_candidate: int = 2):
        ...
        messages.extend([
            {"role": "user", "content": "I'm working on NICE classification for the intellectual property"},
